...
check.basicConfig(format=LOG_FORMAT, level=getattr(check, opt.log_level.upper()))
check.info(opt)
...
if opt.load_checkpoint is not None:
    check.info("loading checkpoint from {}".format(os.path.join(opt.expt_dir, Checkpoint.CHECKPOINT_DIR_NAME, opt.load_checkpoint)))
